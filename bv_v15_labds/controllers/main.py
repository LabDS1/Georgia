...
class KsFilePreview(http.Controller):
    ...
    @http.route(['/get/lead/details'], type='json', auth="public", methods=['POST'], website=True)
    def get_lead_data(self, res_id=False, model=False, size=False, res_field=False, **kw):
        data_file = None
